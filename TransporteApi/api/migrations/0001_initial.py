# Generated by Django 5.2.5 on 2025-08-25 19:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('H_salida', models.TimeField(blank=True, null=True)),
                ('padres', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='estudiantes', to='api.padres')),
            ],
        ),
        migrations.CreateModel(
            name='Tutor_receptor',
            fields=[
                ...
                ('estudiante', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tutores_receptores', to='api.estudiantes')),
            ],
        ),
    ]
